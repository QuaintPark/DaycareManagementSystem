<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Account.Master" AutoEventWireup="true" CodeBehind="OfficeExpense.aspx.cs" Inherits="QuaintDMS.Account.OfficeExpense" %>
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li>
                        ...
                        <a runat="server" href="~/Account/OfficeExpenseList.aspx" class="btn btn-default"><i class="fa fa-list-alt"></i>List</a>
                    </li>
                </ol>
            </section>
                            ...
                            <div class="box-body user-form">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="txtbxReference">Reference:<span>*</span></label>
                                        <asp:TextBox ID="txtReference" runat="server" CssClass="form-control" placeholder="Reference" required="required"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="txtbxAmount">Amount:<span>*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="txtbxDescription">Description:</label>
